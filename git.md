...
Check out the [Github guides](https://guides.github.com/).

## Project guidelines

Taken and adapted from [https://github.com/wearehive/project-guidelines](https://github.com/wearehive/project-guidelines)

* [Git](git.md#git)
  * [Some Git rules](git.md#some-git-rules)
  * [Git workflow](git.md#git-workflow)
  * [Writing good commit messages](git.md#writing-good-commit-messages)
* [Documentation](git.md#documentation)
* [Environments](git.md#environments)
  * [Consistent dev environments](git.md#consistent-dev-environments)
  * [Consistent dependencies](git.md#consistent-dependencies)
* [Dependencies](git.md#dependencies)
* [Testing](git.md#testing)
* [Structure and Naming](git.md#structure-and-naming)
* [Code style](git.md#code-style)
  * [Some code style guidelines](git.md#code-style-check)
  * [Enforcing code style standards](git.md#enforcing-code-style-standards)
* [Logging](git.md#logging)
* [API](git.md#api)
  * [API design](git.md#api-design)
  * [API security](git.md#api-security)
  * [API documentation](git.md#api-documentation)
...
* Load your deployment specific configurations from environment variables and never add them to the codebase as constants, [look at this sample](https://github.com/132nd-vWing-website/web-client/tree/ef8e8c33512f25ee7d5bfa88a366c57e3a5e1016/config.sample.js).

  _Why:_

  > You have tokens, passwords and other valuable information in there. Your config should be correctly separated from the app internals as if the codebase could be made public at any moment.

  _How:_ &gt; `.env` files to store your variables and add them to `.gitignore` to be excluded. Instead, commit a `.env.example` which serves as a guide for developers. For production, you should still set your environment variables in the standard way. [read more](https://medium.com/@rafaelvidaurre/managing-environment-variables-in-node-js-2cb45a55195f)

* It’s recommended to validate environment variables before your app starts. [Look at this sample](https://github.com/132nd-vWing-website/web-client/tree/ef8e8c33512f25ee7d5bfa88a366c57e3a5e1016/configWithTest.sample.js) using `joi` to validate provided values.
...
* Make sure your team members get the exact same dependencies as you.
  ...
  _I don't like the name_ `Yarn`_:_
...
* Run tests locally before making any pull requests to `master`.
...
* Use a `./config` folder and don't make different config files for different environments.
  ...
  > When you break down a config file for different purposes \(database, API and so on\); putting them in a folder with a very recognizable name such as `config` makes sense. Just remember not to make different config files for different environments. It doesn't scale cleanly, as more deploys of the app are created, new environment names are necessary. Values to be used in config files should be provided by environment variables. [read more...](https://medium.com/@fedorHK/no-config-b3f1171eecd5)
...
* Produce readable production logging. Ideally use logging libraries to be used in production mode \(such as [winston](https://github.com/winstonjs/winston) or [node-bunyan](https://github.com/trentm/node-bunyan)\).
