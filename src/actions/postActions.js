...
import { GET_ERRORS, GET_ALL_NOTAMS, GET_UNREAD_NOTAMS, CLEAR_CURRENT_NOTAMS } from './types';
...
export const getNotams = () => (dispatch) => {
  axios
    ...
    .catch(() => dispatch({ type: GET_ALL_NOTAMS, payload: {} }));
};
...
export const getUnreadNotams = () => (dispatch) => {
  axios
    ...
    .catch(() => dispatch({ type: GET_UNREAD_NOTAMS, payload: [] }));
};
